  ...
  return (
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--background)', padding: '4rem 5%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
      ...
      <div style={{ textAlign: 'center', marginBottom: '4rem', maxWidth: '800px' }}>
        <h1 style={{ fontSize: '3rem', fontWeight: 900, color: '#1e1e2f', marginBottom: '1rem', letterSpacing: '-1px' }}>
          {t('nav.support')}
        </h1>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem', width: '100%', maxWidth: '1000px', marginBottom: '4rem' }}>
        ...
        >
          ...
          <h2 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '0.5rem', color: '#1e1e2f' }}>Soporte por WhatsApp</h2>
        ...
        >
          ...
          <h2 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: '0.5rem', color: '#1e1e2f' }}>Correo Electrónico</h2>
          <p style={{ color: '#64748b', marginBottom: '1.5rem', lineHeight: 1.5 }}>
      ...
      <div style={{ width: '100%', maxWidth: '800px' }}>
        <h2 style={{ fontSize: '2rem', fontWeight: 800, marginBottom: '2rem', color: '#1e1e2f', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
          {[
            ...
            <div key={index} style={{ backgroundColor: 'white', padding: '1.5rem', borderRadius: '16px', border: '1px solid #f1f5f9' }}>
              <h3 style={{ fontSize: '1.1rem', fontWeight: 700, color: '#1e1e2f', marginBottom: '0.5rem' }}>{faq.q}</h3>
